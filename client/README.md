...
A full-stack Agro Products E-Commerce web application built using the MERN stack, designed to provide a smooth online shopping experience for agricultural products such as seeds, fertilizers, grains, and equipment.
The platform includes secure authentication, role-based access (User & Admin), order management, and payment options.
...
📍 Tamil Nadu, India
📫 GitHub: https://github.com/AbipriyaR
